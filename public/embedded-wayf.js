...
//      writeHTML('<img src="https://ds.gakunin.nii.ac.jp/GakuNinDS/images/alert.gif" title="注意:リファラ遮断のためDSから所属IdP情報を取得できません" style="vertical-align:text-bottom; border:0px; width:20px; height:20px;">');
    }
    writeHTML('</label>');
    ...
    writeHTML('<script type="text/javascript" src="/suggest.js"></script>');

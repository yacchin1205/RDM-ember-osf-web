...
export default {
    ...
    support: {
        ...
        faq_paragraph: 'How can it be free? How will GakuNin RDM be useful to my research? What is a registration? Get your questions about GakuNin RDM answered on our ',
        faq_link_text: 'FAQ page',
        faq_button: 'Visit FAQ',
        guides_title: 'GakuNin RDM guides',
        guides_paragraph_1: 'Learn how to use GakuNin RDM for improving your research workflow. Read our ',
    ...
    status: {
        welcome_message: '<h1>Welcome to GakuNin RDM!</h1><p>Visit our <a href="http://help.osf.io/" target="_blank" rel="noreferrer">Guides</a> to learn about creating a project, or get inspiration from <a href="https://osf.io/explore/activity/#popularPublicProjects">popular public projects</a>.</p>',

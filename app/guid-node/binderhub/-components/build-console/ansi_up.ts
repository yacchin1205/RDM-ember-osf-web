 ...
 */
/* eslint-disable no-var, eqeqeq, indent, space-in-parens, prefer-const,
                  camelcase, brace-style, curly, no-multi-spaces, no-extra-semi,
                  quotes, block-scoped-var, nonblock-statement-body-position,
                  no-multi-assign, quote-props, key-spacing, operator-linebreak,
                  comma-dangle, array-bracket-spacing, object-curly-spacing,
                  arrow-parens, consistent-return, padded-blocks, semi-spacing,
                  vars-on-top, no-use-before-define, prefer-destructuring, semi,
                  no-constant-condition, spaced-comment, no-multiple-empty-lines,
                  max-len, space-unary-ops, comma-spacing, no-redeclare */
/* tslint:disable */
//
// INTERFACES
//
